...
description: Proficiency in searching ClinicalTrials.gov for clinical trials by condition,
  phase, and recruitment status, and extracting structured trial listings
metadata:
  category: browser
