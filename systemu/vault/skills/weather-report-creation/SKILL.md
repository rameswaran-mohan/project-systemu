---
name: weather-report-creation
description: Proficiency in capturing current weather data from a web source and compiling
  it into a dated Word document with an embedded screenshot
metadata:
  category: browser
