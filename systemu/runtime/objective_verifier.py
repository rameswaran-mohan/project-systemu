...
Design: a fresh-context completion verifier, capped at 2 verify rounds
and requiring fresh effectful work between re-verifies, combined with a
parallel fork-after-turn review that runs under a restricted tool
whitelist.
"""
