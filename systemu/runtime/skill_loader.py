...
Skill layout convention: skills/<category>/<name>/SKILL.md
Toolset gating: requires_toolsets + fallback_for_toolsets fields.
"""
...
def parse_skill_md(path: Union[str, Path]) -> SkillManifest:
    ...
    # Nested metadata.systemu.{tags, related_skills}
...
def discover_skills(root: Union[str, Path]) -> List[SkillManifest]:
    ...
    Skill layout: ``<root>/<skill-name>/SKILL.md``.
