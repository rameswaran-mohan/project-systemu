...
class TestBundledSkills:
    ...
    Skills are EARNED via auto_skill_extractor (the auto-skill-extraction
    pattern), not PRESCRIBED. Earlier overfit examples (burrito-delivery,
    find-nearby) have been moved to docs/skill-examples/ as format references.
    """
    ...
    def test_bundled_dir_has_readme_explaining_design(self):
        ...
        assert readme.exists(), (
            ...
            "auto_skill_extractor (the auto-skill-extraction pattern), not "
            "bundled by us."
        )
