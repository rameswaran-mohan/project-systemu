...
world_model, census_consent and growth_snapshot - i.e. every store in `_ATOMIC_WRITE_STORES`
(this sentence named five of them while the test enforced eight; it is now the whole set).
